...
| コンポーネント | lwrcl + CycloneDDS | lwrcl + FastDDS | lwrcl + vsomeip | ROS 2 + CycloneDDS | ROS 2 + FastDDS |
|-------------|-------------------:|----------------:|----------------:|------------------:|---------------:|
...
| 指標 | lwrcl + CycloneDDS | lwrcl + FastDDS | lwrcl + vsomeip | ROS 2 + CycloneDDS | ROS 2 + FastDDS |
|-----|:------------------:|:---------------:|:---------------:|:-----------------:|:--------------:|
| ミドルウェアサイズ | **~3.8 MB** ✅ | ~13 MB | **~0.7 MB** ✅ | ~6.0 MB | ~15 MB |
| レイテンシ p50 | ~26 µs | ~33 µs | ~65 µs | ~17 µs | **~15 µs** |
| レイテンシ p90 | **~30 µs** | ~47 µs | ~111 µs | ~38 µs | ~61 µs |
| レイテンシ p99 | **~45 µs** | ~92 µs | ~198 µs | ~43 µs | ~62 µs |
| 移植性 | **QNX / AUTOSAR** ✅ | **QNX** ✅ | **QNX / AUTOSAR** ✅ | Linux のみ | Linux のみ |
| ROS 2 不要 | **Yes** ✅ | **Yes** ✅ | **Yes** ✅ | No | No |

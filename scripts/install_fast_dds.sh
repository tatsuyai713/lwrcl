...
sudo apt update
sudo apt install -y --allow-downgrades gcc g++ make cmake automake autoconf unzip git vim openssl gcc make cmake=3.31.8* cmake-data=3.31.8* curl tar wget p11-kit libasio-dev
